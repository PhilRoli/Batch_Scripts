...
if "%ERRORLEVEL%"=="0" (echo Discord is running) else (
    cd "C:\Users\phili\AppData\Local\Discord\app-0.0.309"
...
if "%ERRORLEVEL%"=="0" (echo DiscordPTB is running) else (
    cd "C:\Users\phili\AppData\Local\DiscordPTB\app-1.0.1005"
...
if "%ERRORLEVEL%"=="0" (echo DiscordCanary is running) else (
    cd "C:\Users\phili\AppData\Local\DiscordCanary\app-1.0.28"
